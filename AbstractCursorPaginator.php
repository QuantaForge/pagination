...
/**
 * @mixin \QuantaForge\Support\Collection
 */
abstract class AbstractCursorPaginator implements Htmlable
{
     ...
     * The current cursor.
     *
     * @var \QuantaForge\Pagination\Cursor|null
     */
    protected $cursor;
     ...
     * @param  bool  $isNext
     * @return \QuantaForge\Pagination\Cursor
     */
     ...
     *
     * @return \QuantaForge\Contracts\View\Factory
     */
